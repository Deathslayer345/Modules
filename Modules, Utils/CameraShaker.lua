...
local shaker = CameraShaker.new(Enum.RenderPriority.Camera.Value, function(args)
	workspace.CurrentCamera.CFrame = workspace.CurrentCamera.CFrame * args
end)

shaker:Start()
CameraShaker.ToShake = shaker
return CameraShaker